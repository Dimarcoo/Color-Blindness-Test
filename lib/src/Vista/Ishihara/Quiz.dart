  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: Color.fromRGBO(42, 194, 213, 1.000),
      ),
...
class ResultsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (correctAnswers == 0) {
      message =
          'tiene ceguera. No lograste percibir los diferentes números y colores correctamente. \nLe sugerimos ir donde un especialista en oftalmología para realizar un diagnóstico más detallado.';
    } else if (correctAnswers == totalQuestions) {
      message =
          'no tiene ninguna patología. Su capacidad visual para percibir los colores se encuentra en óptimas condiciones.';
    } else {
      message =
          'tiene Discromatopsia Congénita en los colores rojo y verde. Esta patología es el resultado de la alteración en uno o más foto pigmentos de los conos oculares.\nLe sugerimos ir donde un especialista en oftalmología para realizar un diagnóstico más detallado.';
    }
    return Scaffold(
      //APP BAR DIAGNOSTICO
      appBar: AppBar(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image(
                image: AssetImage('asset/images/diagnostico.png'),
                fit: BoxFit.cover,
              ),
            ),
            Container(
